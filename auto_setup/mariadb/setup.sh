...
MARIADB_SHARED_DOWNLOAD_PATH=https://downloads.mariadb.com/files/MariaDB/yum/10.0/rhel/6/x86_64/rpms/$MARIADB_SHARED.rpm

MARIADB_CLIENT=MariaDB-10.0.21-centos6-x86_64-client
MARIADB_CLIENT_DOWNLOAD_PATH=https://downloads.mariadb.com/files/MariaDB/yum/10.0/rhel/6/x86_64/rpms/$MARIADB_CLIENT.rpm


MARIADB_SERVER=MariaDB-10.0.21-centos6-x86_64-server
MARIADB_SERVER_DOWNLOAD_PATH=https://downloads.mariadb.com/files/MariaDB/yum/10.0/rhel/6/x86_64/rpms/$MARIADB_SERVER.rpm

MARIADB_COMMON=MariaDB-10.0.21-centos6-x86_64-common
MARIADB_COMMON_DOWNLOAD_PATH=https://downloads.mariadb.com/files/MariaDB/yum/10.0/rhel/6/x86_64/rpms/$MARIADB_COMMON.rpm

MARIADB_COMPAT=MariaDB-10.0.21-centos6-x86_64-compat
MARIADB_COMPAT_DOWNLOAD_PATH=https://downloads.mariadb.com/files/MariaDB/yum/10.0/rhel/6/x86_64/rpms/$MARIADB_COMPAT.rpm
